...
export const CATEGORY_ERROR =
  "Invalid category (use home, entertainment, streaming_service, personal, business, education, rent, mortgage, insurance, subscription, renewal, payment_plan, condo_fees)";
