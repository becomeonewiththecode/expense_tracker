...
**Budgeting:** See [**BUDGETING.md**](./BUDGETING.md) for **`budget_periods`** / **`budget_lines`**, **`GET`/`PUT`/`DELETE /api/budgets/:year/:month`**, threshold **`user_notifications`**, and Reports monthly variance/charts/exports.
