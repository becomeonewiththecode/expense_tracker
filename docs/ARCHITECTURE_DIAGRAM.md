...
| Main navigation (authenticated shell) | **`Layout.jsx`** — **Import**, **Lists** dropdown (**Expenses**, **Renewals**, **Prescriptions** in that order), **Reports**; avatar **account menu** (**Profile**, **Upcoming renewals** when applicable, **Sign out**) |
