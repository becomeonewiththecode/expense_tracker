...
The **Reports** page shows **charts** of spending for different periods. The **Upcoming renewals** panel appears only on **Import** and **Your expenses**, not here or on **Profile**.
