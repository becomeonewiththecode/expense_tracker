      ...
      <div className="w-full max-w-sm space-y-6">
        <div>
          ...
          <p className="text-th-subtle text-sm mt-1">
            Use the recovery code you saved from <strong className="text-th-tertiary">Profile</strong>. Nothing is sent by
            email.
          </p>
          <p className="text-th-muted text-xs mt-2 leading-relaxed">
            After resetting, sign in with your usual <span className="text-th-subtle">email address</span> and the new
        ...
        <div className="bg-th-surface border border-th-border rounded-xl p-6 shadow-xl space-y-4">
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="recovery-code" className="block text-xs font-medium text-th-subtle mb-1">
                Recovery code
              </label>
              <textarea
                id="recovery-code"
                ...
                autoComplete="off"
                spellCheck={false}
                className="w-full rounded-lg bg-th-input border border-th-border-bright px-3 py-2 text-white text-sm font-mono focus:outline-none focus:ring-2 focus:ring-emerald-500/50"
                placeholder="Paste the full code"
                required
              />
            </div>
            <div>
              <label htmlFor="recover-new" className="block text-xs font-medium text-th-subtle mb-1">
                New password
              </label>
              <input
                id="recover-new"
            ...
            <div>
              <label htmlFor="recover-confirm" className="block text-xs font-medium text-th-subtle mb-1">
